## This application is a mini project weather forcast report web based application which provides a useful way to retrieve and display current weather data for various cities. 
